...
const Index = () => {
    ...
    const [biontechUsersWithCovidProcessInfo, setBiontechUsersWithCovidProcessInfo] = useState([]);
    ...
    useEffect(() => {
        calculateRate();
    }, [biontechUsersWithCovidProcessInfo]);
    ...
    const calculateRate = () => {
        ...
        biontechUsersWithCovidProcessInfo.map( (person) =>{
        ...
        const users = await dashboardService
            ...
            .then(async (response) => {
                ...
                response.map( (user) =>{
                    ...
                    if( user.stDoseOfVaccine1 === BIONTECH
                        || user.stDoseOfVaccine2 === BIONTECH
                        || user.stDoseOfVaccine3 === BIONTECH
                        || user.stDoseOfVaccine4 === BIONTECH  ) sinovacUsers.push(user.id);
                })
                ...
                await covidProcessService.getUsersProcess().then( (res) =>{
                    ...
                    setBiontechUsersWithCovidProcessInfo(sinovacUsersWithCovidProcessInfoX);
                } );
            ...
            <div className='container'>
                <div className="container container-margin">
                    ...
                    <div className="second-container marginTop30">
                        <div className="title">
                            <h4>BioNTech</h4>
                            <p>Processes in individuals who are vaccinated with Biontech and do not have a chronic disease.</p>
                        </div>
                        <div className="row " >
