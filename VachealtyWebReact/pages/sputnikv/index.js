...
const Index = () => {
    ...
    const [sputnikVUsersWithCovidProcessInfo, setSputnikVUsersWithCovidProcessInfo] = useState([]);
    ...
    useEffect(() => {
        calculateRate();
    }, [sputnikVUsersWithCovidProcessInfo]);
    ...
    const calculateRate = () => {
        ...
        sputnikVUsersWithCovidProcessInfo.map( (person) =>{
        ...
        const users = await dashboardService
            ...
            .then(async (response) => {
                ...
                response.map( (user) =>{
                    ...
                    if( user.stDoseOfVaccine1 === SPUTNIKV
                        || user.stDoseOfVaccine2 === SPUTNIKV
                        || user.stDoseOfVaccine3 === SPUTNIKV
                        || user.stDoseOfVaccine4 === SPUTNIKV  ) sinovacUsers.push(user.id);
                })
                ...
                await covidProcessService.getUsersProcess().then( (res) =>{
                    ...
                    setSputnikVUsersWithCovidProcessInfo(sinovacUsersWithCovidProcessInfoX);
                } );
            ...
            <div className='container'>
                <div className="container container-margin">
                    ...
                    <div className="second-container marginTop30">
                        <div className="title">
                            <h4>Sputnik V</h4>
                            <p>Processes in individuals who are vaccinated with SputnikV and do not have a chronic disease.</p>
                        </div>
                        <div className="row " >
