...
const Index = () => {
    ...
    const [turkovacUsersWithCovidProcessInfo, setTurkovacUsersWithCovidProcessInfo] = useState([]);
    ...
    useEffect(() => {
        calculateRate();
    }, [turkovacUsersWithCovidProcessInfo]);
    ...
    const calculateRate = () => {
        ...
        turkovacUsersWithCovidProcessInfo.map( (person) =>{
        ...
        const users = await dashboardService
            ...
            .then(async (response) => {
                ...
                response.map( (user) =>{
                    ...
                    if( user.stDoseOfVaccine1 === TURKOVAC
                        || user.stDoseOfVaccine2 === TURKOVAC
                        || user.stDoseOfVaccine3 === TURKOVAC
                        || user.stDoseOfVaccine4 === TURKOVAC  ) {sinovacUsers.push(user.id);console.log("user",user);}
                })
                ...
                await covidProcessService.getUsersProcess().then( (res) =>{
                    ...
                    setTurkovacUsersWithCovidProcessInfo(sinovacUsersWithCovidProcessInfoX);
                } );
            ...
            <div className='container'>
                <div className="container container-margin">
                    ...
                    <div className="second-container marginTop30">
                        <div className="title">
                            <h4>TurkoVac</h4>
                            <p>Processes in individuals who are vaccinated with Turkovac and do not have a chronic disease.</p>
                        </div>
                        <div className="row " >
